...
-   `r emoji("coder")` Lover of R and wanted to introduce R at work over Power BI

-   `r emoji("globe")` Just returned from a trip to Taiwan

-   `r emoji("heart")` Misses eating dumplings everyday for breakfast!
:::
:::::
...
<!-- ::::: columns -->
<!-- ::: {.column width="40%"} -->
<!-- <center><img src="images/profile-pics/minh.jpg" width="200px"/></center> -->
...
<!-- ::: {.column width="60%"} -->
<!-- -   `r emoji("graduation")` Just started her PhD in ... -->

<!-- -   `r emoji("globe")` Home country is ... -->

<!-- -   `r emoji("coder")` Worked in fields of ... -->

<!-- -   `r emoji("coder")` Research underpinned by .. -->
